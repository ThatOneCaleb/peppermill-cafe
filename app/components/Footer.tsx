...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-coffee overflow-hidden" ref={ref}>
      {/* Decorative diner-style top border */}
      <div className="relative">
        <div className="h-1 bg-gradient-to-r from-maple via-egg-yolk to-maple" />
        <div
          className="h-8 opacity-[0.06]"
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, transparent, transparent 10px, #F5ECD7 10px, #F5ECD7 20px)",
          }}
        />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-14">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <svg className="w-4 h-4 text-maple mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <svg className="w-4 h-4 text-maple flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
